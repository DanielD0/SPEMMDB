...
<head>
    ...
    <link rel="stylesheet" href="css/style_personas.css">
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p>Noticias</p>
                <li class="active">
                    <a href="#" data-toggle="collapse" aria-expanded="false">Nota informativa -
                        Nueva ley para el Estado de Puebla</a>
                </li>
                <li>

                    <a href="#" data-toggle="collapse" aria-expanded="false">Boletín informativo 29-Abril-2020 </a>

                </li>
                <li>
                    <a href="#">Boletín informativo Abril-2020</a>
                </li>
                <li>
                    <a href="#">Compendio de acciones, planes y medidas emitidas
                        por organismo públicos para combatir el COVID-19</a>
                </li>
                <li>
                    <a href="#">Acciones extraordinarias para atender la emergencia sanitaria generada por el COVID-19</a>
                </li>
                <li>
                    <a href="#">Acciones extraordinarias asumidas por el gobierno Federal para el COVID-19</a>
                </li>
                <li>
                    <a href="#">09 DE MARZO UN DÍA SIN MUJERES</a>
                </li>
                <li>
                    <a href="#">REFORMAS FISCALES 2020</a>
                </li>
                <li>
                    <a href="#">SIMULACÓN DE CFDIS_V2</a>
                </li>
                <li>
                    <a href="#">Aspectos Relevantes de paquetes Economico 2020</a>
                </li>
                <li>
                    <a href="#">Circular Beneficios CDMX</a>
                </li>
                <li>
                    <a href="#">Cumbre "Mi lucha es rosa"</a>
                    <p>22 de mayo 2018</p>
                </li>
            </ul>
            ...
            <ul class="list-unstyled CTAs">
                <li>
                    <a href="" class="">Nuestro registro en DUNS 816636666</a>
                </li>
        ...
        <div id="">
          ...
          <!--Creacion del contenido de body-->
